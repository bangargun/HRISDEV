...
# =====================================================
# HRIS BAROKAH - Build Script v1.9
...
echo "=== [HRIS Barokah v1.9 Build] API Target: https://api.barokahgroupindonesia.tech/api ==="
...
# ==========================================
echo ""
echo "=== [1/2] Building Mobile Karyawan v1.9 (Phone Edition) ==="
...
if [ -f build/app/outputs/flutter-apk/app-release.apk ]; then
  cp build/app/outputs/flutter-apk/app-release.apk "$DEPLOY_DIR/BarokahGrup_Karyawan_Mobile_v1.9.apk"
  cp build/app/outputs/flutter-apk/app-release.apk "$ARTIFACT_DIR/BarokahGrup_Karyawan_Mobile_v1.9.apk"
  echo "✅ Mobile APK berhasil: $DEPLOY_DIR/BarokahGrup_Karyawan_Mobile_v1.9.apk"
elif [ -f build/app/outputs/flutter-apk/app-arm64-v8a-release.apk ]; then
  cp build/app/outputs/flutter-apk/app-arm64-v8a-release.apk "$DEPLOY_DIR/BarokahGrup_Karyawan_Mobile_v1.9.apk"
  cp build/app/outputs/flutter-apk/app-arm64-v8a-release.apk "$ARTIFACT_DIR/BarokahGrup_Karyawan_Mobile_v1.9.apk"
  echo "✅ Mobile APK berhasil: $DEPLOY_DIR/BarokahGrup_Karyawan_Mobile_v1.9.apk"
else
...
# ==========================================
echo ""
echo "=== [2/2] Building Tablet Operasional v1.9 (Landscape Edition) ==="
...
if [ -f build/app/outputs/flutter-apk/app-release.apk ]; then
  cp build/app/outputs/flutter-apk/app-release.apk "$DEPLOY_DIR/BarokahGrup_Operasional_Tablet_v1.9.apk"
  cp build/app/outputs/flutter-apk/app-release.apk "$ARTIFACT_DIR/BarokahGrup_Operasional_Tablet_v1.9.apk"
  echo "✅ Tablet APK berhasil: $DEPLOY_DIR/BarokahGrup_Operasional_Tablet_v1.9.apk"
elif [ -f build/app/outputs/flutter-apk/app-arm64-v8a-release.apk ]; then
  cp build/app/outputs/flutter-apk/app-arm64-v8a-release.apk "$DEPLOY_DIR/BarokahGrup_Operasional_Tablet_v1.9.apk"
  cp build/app/outputs/flutter-apk/app-arm64-v8a-release.apk "$ARTIFACT_DIR/BarokahGrup_Operasional_Tablet_v1.9.apk"
  echo "✅ Tablet APK berhasil: $DEPLOY_DIR/BarokahGrup_Operasional_Tablet_v1.9.apk"
else
...
echo ""
echo "============================================"
echo " ✅ HRIS Barokah APK Build v1.9 Selesai!"
echo "============================================"
echo " Mobile Karyawan   : $DEPLOY_DIR/BarokahGrup_Karyawan_Mobile_v1.9.apk"
echo " Tablet Operasional: $DEPLOY_DIR/BarokahGrup_Operasional_Tablet_v1.9.apk"
